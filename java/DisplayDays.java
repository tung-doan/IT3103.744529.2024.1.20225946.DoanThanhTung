...
public class DisplayDays {
	public static void main(String[] args) {
		...
		int month;
		System.out.println("Doan Thanh Tung - 5946 - Enter a month (E.g: January, Jan., Jan, or 1); ");
		...
		/*
		 * Check leap year If a year is fully divisible by 400 or is divisible by 4 and
